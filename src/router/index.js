...
const routes = [
  ...
  { path: '/docker/change/:docker', component: () => import('../views/docker/dockerChange.vue'), props: true, meta: { hideAppBar: false, title: 'Change Docker', description: 'Change Docker container settings' } },
  {
    path: '/docker/compose',
  ...
  { path: '/mosHub', component: () => import('../views/mosHub.vue'), props: (route) => ({ hubType: route.query.hubType || '' }), meta: { hideAppBar: false, title: 'MOS Hub', description: 'Manage MOS Hub' } },
  ...
  { path: '/mosSettings/docker', component: () => import('../views/mosSettings/dockerService.vue'), meta: { hideAppBar: false, title: 'MOS Settings - Docker', description: 'Manage Docker settings' } },
  ...
  { path: '/mosSettings/usbDevices', component: () => import('../views/mosSettings/usbDevices.vue'), meta: { hideAppBar: false, title: 'MOS Settings - USB Devices', description: 'Manage USB devices' } },
  { path: '/mosSettings/pciDevices', component: () => import('../views/mosSettings/pciDevices.vue'), meta: { hideAppBar: false, title: 'MOS Settings - PCI Devices', description: 'Manage PCI devices' } },
  ...
  { path: '/mosSettings/notifications', component: () => import('../views/mosSettings/notifications.vue'), meta: { hideAppBar: false, title: 'MOS Settings - Notifications', description: 'Manage notification settings' } },
